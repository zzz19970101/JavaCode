...
//        }
    ...
    private void modifyCustomer() {
        ...
        System.out.print("性别（" + customer1.getGender() + "）:");
...
//            i++;
//        }
//        for (int i = 0; i < list.getAllCustmors().size(); i++) {
//            Customer[] cust = list.getAllCustmors();
//            System.out.println((i + 1)  + "\t\t" + cust[i].getName() + "\t\t" + cust[i].getGender() + "\t\t" + cust[i].getAge() + "\t\t"
//                    + cust[i].getPhone() + "\t\t" + cust[i].getEmail());
//        }
        int i = 0;
        for (Customer c : list.getAllCustmors()){
